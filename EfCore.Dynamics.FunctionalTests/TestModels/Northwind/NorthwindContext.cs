...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private const short Quantity = 50;
    private const string SearchTerm = "A";
    ...
    public void ConfigureFilters(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDetail>().HasQueryFilter(od => EF.Property<short>(od, "Quantity") > Quantity);
