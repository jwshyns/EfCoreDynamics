...
public class Customer : IComparable<Customer>
{
    ...
    // Custom ctor binding
    public Customer(DbContext context, ILazyLoader lazyLoader, Guid customerID)
    {
    ...
    protected bool Equals(Customer other) => Equals(CustomerID, other.CustomerID);

    public override bool Equals(object obj)
    {
        if (obj is null) return false;

        return ReferenceEquals(this, obj) || obj.GetType() == GetType() && Equals((Customer)obj);
    }
    ...
    public int CompareTo(Customer other) => other == null ? 1 : CustomerID.CompareTo(other.CustomerID);
